...
//
//
window.location.getQueryParam=function(e){var n,a,r;return n=e.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]"),a=new RegExp("[\\?&]"+n+"=([^&#]*)"),r=a.exec(location.search),null===r?"":decodeURIComponent(r[1].replace(/\+/g," "))},window.location.updateQueryParam=function(e,n){var a,r,c;return c=location.search,a=new RegExp("([?&])"+e+"=.*?(&|$)","i"),r=c.indexOf("?")!==-1?"&":"?",c.match(a)?null===n?c.replace(a,"$2"):c.replace(a,"$1"+e+"="+n+"$2"):""+c+(null!=n?""+r+e+"="+n:"")};
